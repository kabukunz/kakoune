...
{
   public:
    using ArgumentCompleter = std::function<Completions(
        const Context &, CompletionFlags flags, const String &, ByteCount)>;
...
class CommandManager : public Singleton<CommandManager>
{
   public:
    ...
    Completions complete_command_name(const Context &context, StringView query,
   ...
   private:
    ...
    using CommandMap =
        UnorderedMap<String, CommandDescriptor, MemoryDomain::Commands>;
