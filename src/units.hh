...
namespace Kakoune
{
template <typename RealType, typename ValueType = int> class StronglyTypedNumber
{
   public:
    ...
    friend size_t abs(RealType val)
    {
...
{
    [[gnu::always_inline]] constexpr LineCount(int value = 0)
...
{
    [[gnu::always_inline]] constexpr ByteCount(int value = 0)
...
{
    [[gnu::always_inline]] constexpr CharCount(int value = 0)
