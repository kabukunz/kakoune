...
class InputHandler : public SafeCountable
{
   public:
    ...
    void prompt(StringView prompt, String initstr, Face prompt_face,
                bool password, Completer completer, PromptCallback callback);
...
template <> struct WithBitOps<AutoInfo> : std::true_type
{
};

constexpr Array<EnumDesc<AutoInfo>, 3> enum_desc(AutoInfo)
{
    return {{{AutoInfo::Command, "command"},
