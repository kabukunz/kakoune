...
template <typename It> using RegexUtf8It = utf8::iterator<It, wchar_t, ssize_t>;
...
struct MatchResults : boost::match_results<RegexUtf8It<Iterator>>
{
    ...
    {
        using ParentType =
            typename boost::match_results<RegexUtf8It<Iterator>>::iterator;
...
template <typename Iterator> struct RegexIterator : RegexIteratorBase<Iterator>
{
    ...
    RegexIterator(
        Iterator begin, Iterator end, const Regex &re,
        RegexConstant::match_flag_type flags = RegexConstant::match_default)
        : RegexIteratorBase<Iterator>{Utf8It{begin, begin, end},
                                      Utf8It{end, begin, end}, re, flags}
    {
    }
    ...
    const ValueType &operator*() const
    {
        return *reinterpret_cast<const ValueType *>(
            &RegexIteratorBase<Iterator>::operator*());
    }
    const ValueType *operator->() const
    {
        return reinterpret_cast<const ValueType *>(
...
inline RegexConstant::match_flag_type match_flags(bool bol, bool eol, bool bow,
                                                  bool eow)
{
...
template <typename It> bool regex_match(It begin, It end, const Regex &re)
{
    using Utf8It = RegexUtf8It<It>;
    return boost::regex_match(Utf8It{begin, begin, end},
                              Utf8It{end, begin, end}, re);
}
...
bool regex_match(It begin, It end, MatchResults<It> &res, const Regex &re)
{
    using Utf8It = RegexUtf8It<It>;
    return boost::regex_match(Utf8It{begin, begin, end},
                              Utf8It{end, begin, end}, res, re);
}

template <typename It>
bool regex_search(
    It begin, It end, const Regex &re,
    RegexConstant::match_flag_type flags = RegexConstant::match_default)
{
    using Utf8It = RegexUtf8It<It>;
    return boost::regex_search(Utf8It{begin, begin, end},
                               Utf8It{end, begin, end}, re);
}

template <typename It>
bool regex_search(
    It begin, It end, MatchResults<It> &res, const Regex &re,
    RegexConstant::match_flag_type flags = RegexConstant::match_default)
{
    using Utf8It = RegexUtf8It<It>;
    return boost::regex_search(Utf8It{begin, begin, end},
